  ...
  return [
    {
      ...
      content: 'Being aware of breast cancer symptoms can help with early detection. While these symptoms can be caused by conditions other than cancer, it\'s important to have them evaluated by a healthcare provider.',
      bullets: [
    ...
    },
    {
      ...
      content: 'Breast cancer symptoms may differ for each person. Some people have no signs or symptoms at all. It\'s important to remember that many of these symptoms can happen with other conditions that are not cancer.',
      bullets: []
    },
    {
      title: 'What to Do If You Notice Symptoms',
      content: 'If you notice any changes in your breast, it\'s important to:',
      bullets: [
  ...
  return [
    ...
    },
    {
      ...
      bullets: [
        ...
        'Triple-Negative Breast Cancer: Cancer cells that don't have estrogen or progesterone receptors and don't make too much HER2 protein',
        'HER2-Positive Breast Cancer: Cancer cells that make too much of a protein called HER2'
      ]
    },
    {
      title: 'Risk Factors',
      content: 'Various factors can influence breast cancer risk. Some can't be changed, while others can be modified:',
      bullets: [
