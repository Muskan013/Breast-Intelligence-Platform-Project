...
function BlogHome() {
  ...
  return (
    <div className="relative py-20 overflow-hidden bg-gray-950 min-h-screen">
      {/* Background elements */}
      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl font-bold text-white mb-5 bg-clip-text text-transparent bg-gradient-to-r from-white via-primary to-white">
        ...
        <div className="mb-12 flex flex-wrap gap-2 justify-center">
          <Button
            ...
            className={`rounded-full ${filter === null ? 'bg-primary' : 'bg-gray-800/50 border-white/10 text-gray-300'}`}
          ...
          {categories.map(category => (
            <Button
              ...
              className={`rounded-full ${filter === category ? 'bg-primary' : 'bg-gray-800/50 border-white/10 text-gray-300'}`}
          ...
          {tags.slice(0, 5).map(tag => (
            <Button
              ...
              className={`rounded-full ${filter === tag ? 'bg-primary' : 'bg-gray-800/50 border-white/10 text-gray-300'}`}
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center mt-4">
                  <Link href={`/blog/${article.id}`}>
                    <Button className="btn-futuristic text-sm py-1 px-3">
                      Read Article <ArrowRight className="ml-1 h-3 w-3" />
                    </Button>
                  </Link>
                  
                  <div className="flex gap-2">
                    <Button variant="ghost" size="icon" className="h-8 w-8 rounded-full bg-gray-800/50 text-gray-400 hover:text-white hover:bg-gray-700/50">
